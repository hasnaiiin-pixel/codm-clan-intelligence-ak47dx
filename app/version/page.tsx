    ...
    <main className="ak-login-page">
      <section className="ak-login-wrap">
        <div className="ak-login-card">
          ...
          <p className="ak-lead">Versione V8.2: Telegram professionale, reminder selezionabili, messaggio evento iniziato, template/calibrazione/import più coerenti e layout eventi compatto.</p>
          <div className="notice top-gap"><strong>Marker:</strong> V8_2_PRO_TELEGRAM_REMINDERS_TEMPLATES_UI_OK</div>
