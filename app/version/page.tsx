    ...
    <main className="ak-login-page">
      <section className="ak-login-wrap">
        <div className="ak-login-card">
          ...
          <p className="ak-lead">Versione V8.2B: fix calibrazione/import con stessa geometria immagine, menu telefono/template visibile e link evento solo manuali.</p>
          <div className="notice top-gap"><strong>Marker:</strong> V8_2B_IMPORT_CALIBRATION_LINK_FIX_OK</div>
          ...
          <div className="notice top-gap"><strong>Telegram:</strong> riepilogo completo evento; reminder esterni; nessun link Calendar automatico</div>
