...
-- Permessi granulari + associazione account/player.
-- Script sicuro/idempotente: eseguibile anche se V13.1 è già stato applicato.
...
create index if not exists idx_players_user_id_v13_2 on public.players(user_id);
